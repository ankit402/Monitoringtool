...
using Monitoring_FrontEnd.Infrastructure.ApplicationUserClaims;
using Monitoring_FrontEnd.Infrastructure.AppSettingsModels;
...
using Monitoring_FrontEnd.Infrastructure.Startup;

namespace Monitoring_FrontEnd
{
